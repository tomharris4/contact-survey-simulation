...
sb.heatmap(cm_age, ax=ax[0,0], cmap="RdBu", center = 0, vmin = -1 * diff_max,  vmax = diff_max, cbar_kws={'label': 'Mean # unique contacts \n per day'})
...
ax[0,1].set(title='Elderly (65+ years)')
ax[0,1].grid()
...
plt.tight_layout()
plt.savefig('../Figures/figure3_' + pathogen + '.pdf')
