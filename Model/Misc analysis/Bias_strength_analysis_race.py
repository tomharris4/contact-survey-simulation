...
ax[2].scatter([r_1[5]],[ar_diff[5]],color='g',label='$r_{1}=0.5$')
# for i in range(10):
...
plt.tight_layout()
plt.savefig('../Figures/supp_bias_strength_race_' + pathogen + '_' + metric + '.pdf')
