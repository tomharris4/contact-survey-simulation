...
sb.heatmap(cm_eth, ax=ax[0], cmap="RdBu", center = 0, vmin = -1 * diff_max,  vmax = diff_max, cbar_kws={'label': 'Mean # unique contacts \n per day'})
...
ax[2].set_xlabel('Bias magnitude ($r_{H}$)')
if metric == 'ar':
